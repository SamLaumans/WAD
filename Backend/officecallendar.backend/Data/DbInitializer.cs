    ...
    public static class DbInitializer
    {
        public static void Seed(AppDbContext context)
        {
            ...
            var users = new List<User>
            {
                ...
                new User { nickname = "sara", username = "sarah", email = "sarah@example.com", password = "1234", role = 0, creation_date = DateTime.Now },
                new User { nickname = "admine", username = "admin", email = "admin@example.com", password = "1234", role = 1, creation_date = DateTime.Now },
                ...
                new User { nickname = "tommy", username = "tom", email = "tom@example.com", password = "1234", role = 0, creation_date = DateTime.Now },
                ...
                new User { nickname = "timmy", username = "tim", email = "tim@example.com", password = "1234", role = 0, creation_date = DateTime.Now }
